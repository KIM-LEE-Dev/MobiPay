...
import com.kimnlee.cardmanagement.presentation.screen.CardImage
    ...
    Scaffold(
        topBar = {
            TopAppBar(
                ...
                navigationIcon = {
                    IconButton(onClick = onNavigateToCardPage) {
            ...
            OutlinedTextField(
                ...
                onValueChange = { newValue ->
                    ...
                    if (isApplyToAll) {
                        ...
                        oneTimeLimits = oneTimeLimits.toMutableList()
                            .apply { this[pagerState.currentPage] = filteredValue }
                        val oneTimeError = validateLimits(filteredValue)
                        oneTimeLimitErrors = oneTimeLimitErrors.toMutableList()
                            .apply { this[pagerState.currentPage] = oneTimeError }
                    }
                },
                label = {
                    Text(
